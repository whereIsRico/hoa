...
// See Resident.incrementTokenVersion. Called from platformAuth.js's
// /platform-reset-password (ARG-6).
...
module.exports = { findByEmail, findById, verifyPassword, updatePassword, getTokenVersion, incrementTokenVersion };
